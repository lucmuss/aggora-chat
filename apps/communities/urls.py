...
urlpatterns = [
    ...
    path("validate-field/", views.validate_community_field, name="community_validate_field"),
    ...
    path("<slug:slug>/owner/", views.community_owner_dashboard_view, name="community_owner_dashboard"),
